...
The next performance work should focus on reuse policies for rows/columns that
are all zero at plan creation, tuned residue block sizing, and switching from
